http://localhost:5000/czesc/Nikodem (http://localhost:5000/czesc/<imie>) - Wypisuje na stronię ,,Cześć <imie>", <imie> jest to rzecz którą wpisałeś w url.
...
http://localhost:5000/start - Cofa stronę